...
namespace knitsim
{
    ...
    public:
        ...
        GraphConfig(float step_size_x = 0.5,
                    float step_size_y = 1,
                    float offset_bidirectional = 0.1,
                    float offset_purl = 0.4,
                    float offset_knit = -0.3,
                    float yarn_thickness = 0.03,
                    Eigen::Vector3f up_vector = Eigen::Vector3f(1, 0, 0),
