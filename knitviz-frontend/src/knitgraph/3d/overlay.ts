...
export class KnitGraphOverlay {
  ...
  constructor(
    public manager: KnitGraphOverlayManager,
    public n: KnitNode3D,
  ) {
    this.overlay = this.manager.svg.append("g").attr("class", "overlay").attr("id", n.id);
    this.link = this.overlay
      .append("path")
      .attr("class", "link")
      .attr("d", "M0,0 L0,0")
      .style("stroke", "grey")
